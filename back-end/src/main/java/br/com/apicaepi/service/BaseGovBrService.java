...
import br.com.apicaepi.util.CaepiUtil;
import br.com.apicaepi.util.DateConverter;
...
public class BaseGovBrService {
    ...
    public static List<Caepi> getBaseCaepi(){
        try {
            LocalDateTime lastModified = lastModifiedTimeBaseCaepiByGovBr();
