...
import br.com.apicaepi.service.exception.ObjectNotFoundException;
import br.com.apicaepi.util.HandlerCNPJ;
...
public class CaepiService {
    ...
    public CaepiDto findSimpleByNumber(long number) {
        Caepi caepi = repoCaepi.findSimpleByNumber(number);
